...
<body class="vertical w-ui" data-pagename="">
	...
	<div class="signup-container">
		...
		<div class="right">
			<form id="overlay-signup-form" >
			   <form:form method="POST" modelAttribute="signup" action="/BookApp/signup">
				<input type="text" id="overlay-signup-form-name" path="fullname" name="fullnamename" class="signup-name" placeholder="Full Name" autocomplete="off">
				<input type="text" id="overlay-signup-form-email" path="username" name="username" placeholder="Email" autocomplete="off">
				<input type="password" id="overlay-signup-form-pass" path=password" name="password" placeholder="Password" autocomplete="off">

				<p class="agree">By signing up, you agree to our <a href="/terms-of-service/" target="_blank">Terms of Service</a> and <a href="/privacy/" target="_blank">Privacy Policy</a></p>

				<p id="overlay-signup-form-error"></p>

				<p class="submit-button">
					<input type="submit" class="signup-btn submit-btn" value="Sign Up Free">
				</p>
