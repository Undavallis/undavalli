...
<nav class="navbar navbar-default">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/NewsSearching/">NewsX</a>
    </div>
...
<div class="panel panel-default">
  ...
  <form:form method="POST" modelAttribute="news" action="/NewsSearching/addnews">
 

<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2">headlines</span>
  <form:input type="text" class="form-control" required path="headlines" required="true" placeholder="Enter Headlines" aria-describedby="sizing-addon2"/>
</div>
<br>
...
<div class="input-group">
  ...
  <form:input type="text" class="form-control" required path="imageUrl" required="true" placeholder="Enter image url" aria-describedby="sizing-addon2"/>
</div>
<br>
<div class="input-group">
...
<form:select class="form-control" path="newsType" id="sell">
...
<div class="form-group">
  ...
  <form:textarea class="form-control" rows="5" path="mainStory" required="true" id="comment"></form:textarea>
</div>
